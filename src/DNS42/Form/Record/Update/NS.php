...
class DNS42_Form_Record_Update_NS extends Gatuf_Form {
	private $record;
	private $dominio;
	...
	public function clean () {
		...
		$sql = new Gatuf_SQL ('type="NS" AND dominio=%s AND name=%s AND rdata=%s AND id != %s', array ($this->dominio->id, $this->cleaned_data['name'], $this->cleaned_data['hostname'], $this->record->id));
